...
class SpeechStream(stt.RecognizeStream):
    ...
    def _get_speech_data_from_fragments(self) -> list[stt.SpeechData]:
        """
        Get speech data objects for the current fragment list.

        Each speech fragments is grouped by contiguous speaker and then
        returned as a SpeechData object with the `speaker_id` field set to
        ...
        Returns:
            list[SpeechData]: The list of SpeechData grouped fragments.
        """
    ...
    def _get_speech_data_from_fragment_group(
        ...
        """
        Take a group of fragments and piece together into SpeechData.
        ...
        Returns:
            SpeechData: The SpeechData object for the group.
        """
